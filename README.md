...
A browser escape-room game. Six rooms, five minutes each, no frameworks, no backend, no build step — open `index.html` and play.
...
- `index.html` — the six scenes and the lock templates
